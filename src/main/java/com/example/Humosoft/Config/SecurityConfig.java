...
public class SecurityConfig {
    ...
    private final static String[] WHITE_URL = {"/auth/signin","/mails/sendrequest","/users/forgot-password","/attendances/check-in/*","/attendances/check-out/*","/attendances/company"};
